...
class S3Helper:
    def __init__(
        ...
        self.bucket_name = "test-fm-user-bucket"
    ...
    async def list_folder_contents(
        ...
        try:
            ...
            if user_id and hasattr(self, 'permission_manager') and self.permission_manager:
                    ...
                    for file in page.get('Contents', []):
                        ...
                        if key != prefix and not key.endswith(delimiter):
                            files.append({
                                ...
                                'last_modified': file.get('LastModified', datetime.now())
                            })
    ...
    async def create_folder(self, folder_path: str, user_id: Optional[str] = None) -> bool:
        """
    ...
    async def delete_folder(self, folder_path: str, user_id: Optional[str] = None) -> bool:
        """
    ...
    async def get_bucket_stats(self) -> Dict:
        ...
        try:
            ...
            stats = {
                ...
                'usage_percentage': round((total_size / (50 * 1024 * 1024 * 1024)) * 100, 2)  # Assuming 50GB limit
            }
